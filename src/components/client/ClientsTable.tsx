  ...
  const tableHeader = useMemo(() => (
    <TableHeader>
      <TableRow className="bg-muted/50">
        ...
        <TableHead className="font-medium text-center min-w-[110px]">Clínicas</TableHead>
        <TableHead className="font-medium text-center min-w-[110px]">Ryka</TableHead>
        <TableHead className="font-medium text-center min-w-[110px]">Entrada</TableHead>
