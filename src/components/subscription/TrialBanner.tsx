...
export function TrialBanner() {
  ...
  if (user?.email?.endsWith("@anjosbusiness.com.br") || user?.email?.endsWith("@anjosbusiness.com") || user?.email === "m.quintana@me.com" || user?.email === "coachevertonsantos@gmail.com") return null;
