...
> = {
  ...
  blue: {
    ...
    headlineText: "text-blue-700 dark:text-blue-300",
  },
  emerald: {
  ...
  rose: {
    ...
    grad: "from-rose-500/10 via-rose-500/5 to-transparent",
  ...
  slate: {
    ...
    headlineText: "text-slate-700 dark:text-slate-200",
  },
  fuchsia: {
  ...
  cyan: {
    ...
    grad: "from-cyan-500/10 via-cyan-500/5 to-transparent",
    headlineText: "text-cyan-700 dark:text-cyan-300",
  },
};
