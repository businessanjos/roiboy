  ...
  return (
    <div className={cn("space-y-1.5", isFullWidth && "sm:col-span-2")}>
      ...
      {isInscricaoField && required && !value && (
        <p className="text-[11px] font-medium text-warning dark:text-warning bg-warning/10 border border-warning/30 rounded px-2 py-1">
    ...
    return (
      <TooltipProvider delayDuration={150}>
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          ...
          {templates.length === 0 && (
            <div className="mx-5 mb-5 rounded-lg border border-warning/30 bg-warning/5 p-3 text-sm flex items-start gap-2">
    ...
    return (
      <div className="space-y-4">
        ...
        {(() => {
          ...
          if (parcelasInvalido) {
            return (
              <div className="rounded-lg border border-warning/50 bg-warning/10 p-3 text-xs text-warning-strong dark:text-warning">
        ...
        <div className="space-y-4">
          {emptyVars.length > 0 && (
            <div className="rounded-lg border border-warning/30 bg-warning/5 p-4 space-y-3">
              ...
              <div className="grid sm:grid-cols-2 gap-x-4 gap-y-3 pt-2 border-t border-warning/20">
                {emptyVars.map((v) => (
                  <PlaceholderField
                    key={v.key}
                    v={v}
