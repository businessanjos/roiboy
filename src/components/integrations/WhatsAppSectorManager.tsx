...
import { Loader2, MessageSquare, RefreshCw, ShieldAlert, Smartphone, Headphones, DollarSign, ShoppingCart, Crown } from "lucide-react";
...
const WHATSAPP_SECTORS: SectorConfig[] = [
  ...
  { id: "diretoria", name: "Diretoria", description: "Gestão executiva - Everton Pieri", icon: Crown, color: "bg-rose-500/10 text-rose-600" },
];
