...
const WHATSAPP_SECTORS: SectorConfig[] = [
  { id: "operacoes", name: "Customer Success", description: "Atendimento CX/CS e suporte geral", icon: Headphones, color: "bg-primary/10 text-primary" },
  { id: "financeiro", name: "Finanças", description: "Cobranças, boletos e pagamentos", icon: DollarSign, color: "bg-success/10 text-success" },
  { id: "vendas", name: "Vendas", description: "Pipeline comercial e leads", icon: ShoppingCart, color: "bg-info/10 text-info" },
