...
function DealStatusBadge({ status }: { status?: string }) {
  const map: Record<string, { label: string; className: string }> = {
    won: { label: 'Ganho', className: 'bg-success/15 text-success-strong border-success/30' },
    lost: { label: 'Perdido', className: 'bg-danger/15 text-danger-strong border-danger/30' },
    open: { label: 'Aberto', className: 'bg-info/15 text-info-strong border-info/30' },
  };
