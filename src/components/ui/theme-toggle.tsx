...
export function ThemeToggleMenuItem({ onSelect }: { onSelect?: () => void }) {
  const { setTheme, theme } = useTheme();
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex w-full items-center px-2 py-1.5 text-sm rounded-sm hover:bg-accent hover:text-accent-foreground cursor-pointer"
    >
