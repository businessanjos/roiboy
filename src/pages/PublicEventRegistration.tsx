        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className={`mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-4 ${
              result.status === "confirmed" ? "bg-success-soft text-success" : "bg-warning-soft text-warning"
            }`}>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-muted/30 p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Capacity Warning */}
          {!event.has_capacity && (
            <div className="flex items-start gap-2 p-3 bg-warning-soft dark:bg-warning/30 border border-warning dark:border-warning rounded-lg">
