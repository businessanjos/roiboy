...
export default function RoyZapp() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-full bg-[#111b21] rounded-lg border border-[#2a3942]">
  ...
  return (
    <div className="h-full flex bg-[#111b21] -mx-6 -mb-6 -mt-4 overflow-hidden rounded-lg border border-[#2a3942]">
