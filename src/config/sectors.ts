...
export const sectors: Sector[] = [
  {
    ...
    navItems: [
      ...
      { to: "/operations/practice-areas", icon: Tag, label: "Áreas de Atuação", adminOnly: true },
  ...
  },
  {
    ...
    navItems: [
      ...
      { to: "/financial/parcelas", icon: Receipt, label: "Parcelas", permission: PERMISSIONS.CLIENTS_VIEW, group: "Principal" },
      { to: "/financial/alerts", icon: Bell, label: "Alertas", permission: PERMISSIONS.CLIENTS_VIEW, group: "Principal" },
      // Recebimentos & Cobrança
      { to: "/financial/invoices", icon: CreditCard, label: "Faturas", permission: PERMISSIONS.CLIENTS_VIEW, group: "Recebimentos & Cobrança" },
      { to: "/financial/boletos", icon: FileText, label: "Boletos", permission: PERMISSIONS.CLIENTS_VIEW, group: "Recebimentos & Cobrança" },
      ...
      { to: "/financial/cobranca", icon: LayoutGrid, label: "CRM de Cobrança", permission: PERMISSIONS.CLIENTS_VIEW, group: "Recebimentos & Cobrança" },
      { to: "/financial/pagadores", icon: UsersRound, label: "Pagadores", permission: PERMISSIONS.CLIENTS_VIEW, group: "Recebimentos & Cobrança" },
      { to: "/financial/clientes-ativos", icon: Users, label: "Clientes Ativos", permission: PERMISSIONS.CLIENTS_VIEW, group: "Recebimentos & Cobrança" },
      // Operações
      { to: "/financial/reconciliation", icon: Landmark, label: "Conciliação", permission: PERMISSIONS.CLIENTS_VIEW, group: "Operações" },
      { to: "/financial/sales-reconciliation", icon: FileSignature, label: "Conc. Vendas", permission: PERMISSIONS.CLIENTS_VIEW, group: "Operações" },
      { to: "/financial/commissions", icon: Percent, label: "Comissões", permission: PERMISSIONS.CLIENTS_VIEW, group: "Operações" },
      { to: "/financial/importar", icon: ArrowLeftRight, label: "Importar (Cielo/Cheque)", permission: PERMISSIONS.CLIENTS_VIEW, group: "Operações" },
      ...
      { to: "/financial/suppliers", icon: Users, label: "Fornecedores", permission: PERMISSIONS.CLIENTS_VIEW, group: "Cadastros" },
      { to: "/financial/recurring", icon: Repeat, label: "Recorrências", permission: PERMISSIONS.CLIENTS_VIEW, group: "Cadastros" },
      ...
      { to: "/financial/balance-sheet", icon: Building2, label: "Balanço", permission: PERMISSIONS.CLIENTS_VIEW, group: "Em Breve", comingSoon: true },
      { to: "/notifications", icon: Bell, label: "Notificações" },
    ],
  },
  {
