...
export type HRCollaboratorInsert = Omit<HRCollaborator, "id" | "created_at" | "updated_at">;
...
export function useHRCollaborators() {
  ...
  const fetchCollaborators = useCallback(async () => {
    ...
    try {
      ...
      setCollaborators((data || []) as HRCollaborator[]);
    } catch (err) {
  ...
  return { collaborators, loading, refetch: fetchCollaborators, createCollaborator, updateCollaborator, deleteCollaborator };
}
