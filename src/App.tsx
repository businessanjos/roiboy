...
const ClientCheckpoints = lazyRetry(() => import("./pages/ClientCheckpoints"));
...
const BriefingLinkAudit = lazyRetry(() => import("./pages/BriefingLinkAudit"));
                      ...
                      <SectorProvider>
                        ...
                        <Suspense fallback={<PageLoader />}>
                          ...
                          <Route element={<AppLayout />}>
                            ...
                            <Route path="/clients/checkpoints" element={<ClientCheckpoints />} />
                            ...
                            <Route path="/operations/briefing-audit" element={<BriefingLinkAudit />} />
