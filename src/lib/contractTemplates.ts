...
const PLACEHOLDER_ALIASES: Record<string, string[]> = {
  ...
  DOWN_PAYMENT: ["VALOR_ENTRADA", "ENTRADA", "VALOR_SINAL", "SINAL"],
  ENTRADA: ["VALOR_ENTRADA", "DOWN_PAYMENT", "SINAL", "VALOR_SINAL"],
  VALOR_ENTRADA: ["ENTRADA", "DOWN_PAYMENT", "SINAL", "VALOR_SINAL"],
  SINAL: ["VALOR_ENTRADA", "ENTRADA", "DOWN_PAYMENT"],
