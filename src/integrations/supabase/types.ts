  ...
  public: {
    Tables: {
      ...
      ec_mentoring_client_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "ec_mentoring_client_status_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "client_latest_metrics"
            referencedColumns: ["client_id"]
      ...
      pda_import_staging: {
        Row: {
          ...
          meses: string | null
          modelo_mental: string | null
          nivel: string | null
          nome: string | null
          pdi_entregue: string | null
          pdi_feito: string | null
          perfil_dominante: string | null
          perfil_secundario: string | null
          perfil_vaga: string | null
          qm: string | null
          salario_com_encargos: string | null
          salario_liquido: string | null
          salario_sem_encargos: string | null
          setor: string | null
          sinergia: string | null
          sinergia_pct: string | null
          status_asana: string | null
    ...
    Functions: {
      ...
      inactivate_collaborator: {
        Args: { _collaborator_id: string; _reason?: string }
        Returns: Json
      }
