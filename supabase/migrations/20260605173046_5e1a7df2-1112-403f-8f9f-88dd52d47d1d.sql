...
REVOKE ALL ON FUNCTION public.get_admission_portal(TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_admission_portal(TEXT) TO anon, authenticated, service_role;

-- 4) Public write function: candidate uploads a file (path already on storage), updates doc record
