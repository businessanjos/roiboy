UPDATE public.contract_templates SET content_html = $RYKAS$<div class="contract-document"><style>
/* ============================================================
...
.rk-cover-mark{
  display:flex; align-items:center; gap:14px; margin-bottom:96px;
}
.rk-cover-mark .dot{ width:10px; height:10px; background:#fff; border-radius:50%; }
.rk-cover-mark .label{
  font-size:9pt; font-weight:600; letter-spacing:.4em; text-transform:uppercase; color:#fff;
}
.rk-cover-eyebrow{
  font-size:9pt; font-weight:500; letter-spacing:.4em; text-transform:uppercase;
  color:#fff; opacity:.65; margin-bottom:28px;
}
.rk-cover h1{
  font-family:'Playfair Display', Georgia, serif;
  font-size:54pt; line-height:1.02; font-weight:700; margin:0 0 24px; letter-spacing:-.02em; color:#fff;
}
...
.rk-cover-bottom{
  background:#fff; padding:48px 72px 72px;
}
.rk-cover-meta{
  display:grid; grid-template-columns:1fr 1fr 1fr; gap:32px 48px; margin-bottom:48px;
}
.rk-cover-meta .item .k{
  font-size:8pt; font-weight:600; letter-spacing:.28em; text-transform:uppercase;
  color:var(--muted); margin-bottom:8px;
}
.rk-cover-meta .item .v{
  font-family:'Playfair Display', serif; font-size:14pt; font-weight:600; color:var(--ink); line-height:1.3;
}
.rk-cover-footer{
  display:flex; justify-content:space-between; align-items:center; padding-top:24px;
  border-top:1px solid var(--ink); font-size:8.5pt; letter-spacing:.28em;
...
.rk-toc h3{
  font-family:'Playfair Display', serif; font-size:9pt; font-weight:600;
  letter-spacing:.4em; text-transform:uppercase; color:var(--ink);
  margin:0 0 24px; padding-bottom:14px; border-bottom:2px solid var(--ink);
}
.rk-toc ol{ list-style:none; counter-reset:toc; padding:0; margin:0; }
.rk-toc ol li{
  counter-increment:toc; display:flex; align-items:baseline; gap:14px;
  padding:14px 0; border-bottom:1px solid var(--line); font-size:10.5pt;
}
.rk-toc ol li::before{
  content:counter(toc, decimal-leading-zero);
  font-family:'Playfair Display', serif; font-size:13pt; font-weight:600;
...
.rk-section-num{
  font-family:'Playfair Display', serif; font-size:42pt; font-weight:700;
  line-height:1; color:var(--ink); letter-spacing:-.02em;
}
.rk-section-titles{ flex:1; }
.rk-section-titles .eyebrow{
  font-size:8.5pt; font-weight:600; letter-spacing:.32em; text-transform:uppercase;
  color:var(--muted); margin-bottom:8px;
}
.rk-section-titles h2{
  font-family:'Playfair Display', serif; font-size:24pt; font-weight:700;
  margin:0; line-height:1.15; color:var(--ink); letter-spacing:-.015em;
}
...
.rk-clause-num{
  font-family:'Playfair Display', serif; font-size:11pt; font-style:italic;
  font-weight:600; color:var(--ink); padding-top:2px;
}
...
.rk-party .role{
  font-size:8pt; font-weight:600; letter-spacing:.32em; text-transform:uppercase;
  color:#fff; background:#000; padding:6px 10px; display:inline-block; margin-bottom:14px;
}
.rk-party .name{
  font-family:'Playfair Display', serif; font-size:18pt; font-weight:600;
...
.rk-party dt{
  font-size:8pt; font-weight:600; letter-spacing:.18em; text-transform:uppercase;
...
.rk-pullquote{
  ...
  border-left:3px solid var(--ink); padding:8px 0 8px 22px;
  margin:24px 0; max-width:80%;
}

/* ===== Pilares 3P1R ===== */
.rk-pillars{
  display:grid; grid-template-columns:repeat(4,1fr); gap:0;
  border:1px solid var(--ink); margin:24px 0;
}
.rk-pillar{
  padding:22px 20px; border-right:1px solid var(--line); position:relative; background:#fff;
}
...
/* ===== Investimento (hero) ===== */
.rk-hero{
  background:#000; color:#fff; padding:40px 36px; margin:24px 0;
}
.rk-hero .label{
  font-size:8.5pt; font-weight:600; letter-spacing:.4em; text-transform:uppercase;
  color:#fff; opacity:.7; margin-bottom:16px;
}
.rk-hero .total{
  font-family:'Playfair Display', serif; font-size:42pt; font-weight:700;
...
.rk-hero .total-words{
  font-style:italic; font-size:10.5pt; color:#fff; opacity:.75; margin-bottom:28px;
}
.rk-hero-grid{
  display:grid; grid-template-columns:repeat(3,1fr); gap:24px;
  padding-top:24px; border-top:1px solid rgba(255,255,255,.25);
}
.rk-hero-grid .k{
  font-size:8pt; font-weight:600; letter-spacing:.28em; text-transform:uppercase;
  color:#fff; opacity:.7; margin-bottom:6px;
}
.rk-hero-grid .v{
  font-family:'Playfair Display', serif; font-size:14pt; font-weight:600; color:#fff;
}

/* ===== Tabela de penalidades ===== */
.rk-table{ width:100%; border-collapse:collapse; margin:20px 0; font-size:10pt; }
.rk-table thead th{
  text-align:left; font-size:8.5pt; font-weight:600; letter-spacing:.24em;
...
.rk-notice .body .t{
  font-size:8.5pt; font-weight:700; letter-spacing:.28em; text-transform:uppercase;
  color:var(--ink); margin-bottom:8px;
}
...
/* ===== Assinaturas ===== */
.rk-sign-block{
  margin-top:64px; padding-top:40px; border-top:2px solid var(--ink);
}
.rk-sign-intro{
  font-family:'Playfair Display', serif; font-size:13pt; font-style:italic;
  color:var(--ink-2); text-align:center; margin-bottom:56px;
}
...
.rk-sign .role{
  font-size:8.5pt; font-weight:700; letter-spacing:.32em; text-transform:uppercase;
...
.rk-footer{
  ...
  font-size:8.5pt; letter-spacing:.2em; text-transform:uppercase; color:var(--muted);
}
.rk-footer .brand{
  font-family:'Playfair Display', serif; font-size:13pt; font-style:italic;
  font-weight:700; letter-spacing:.04em; text-transform:none; color:var(--ink);
}
...
@media print{
  ...
  .rk-cover-top, .rk-hero, .rk-table thead th, .rk-notice .icon, .rk-party .role{
...
<div class="rk-page rk-cover">
  <div class="rk-cover-top">
    <div class="rk-cover-mark">
      <span class="dot"></span>
      <span class="label">Rykas Mentoring</span>
    </div>
  ...
  <div class="rk-cover-bottom">
    ...
    <div class="rk-cover-footer">
      <span>Confidencial &middot; Documento Particular</span>
...
<div class="rk-page">
  ...
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">I</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Preâmbulo</div>
        <h2>Das Partes Contratantes</h2>
      </div>
    </div>
    ...
    <div class="rk-parties">
      <div class="rk-party">
        ...
        <dl>
          <dt>CNPJ</dt><dd>{{COMPANY_CNPJ}}</dd>
          <dt>Endereço</dt><dd>{{COMPANY_ADDRESS}}</dd>
          <dt>Representante</dt><dd>{{COMPANY_REPRESENTATIVE}}</dd>
        </dl>
      </div>
      <div class="rk-party">
        ...
        <dl>
          <dt>CPF/CNPJ</dt><dd>{{CLIENT_DOCUMENT}}</dd>
          <dt>Endereço</dt><dd>{{CLIENT_ADDRESS}}</dd>
          <dt>E-mail</dt><dd>{{CLIENT_EMAIL}}</dd>
          <dt>Telefone</dt><dd>{{CLIENT_PHONE}}</dd>
        </dl>
      </div>
    </div>
  ...
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">II</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusula Primeira</div>
        <h2>Do Objeto &amp; da Metodologia</h2>
      </div>
    </div>
    ...
    <div class="rk-clause">
      <span class="rk-clause-num">§ 1º</span>
      <p>Os serviços contratados compreendem encontros estruturados, materiais de apoio, acesso a comunidade exclusiva e acompanhamento técnico durante a vigência prevista neste instrumento.</p>
    </div>
    <div class="rk-clause">
      <span class="rk-clause-num">§ 2º</span>
      <p>A metodologia 3P1R&reg; constitui propriedade intelectual exclusiva da <strong>CONTRATADA</strong>, sendo vedada sua reprodução, comercialização ou cessão a terceiros, sob qualquer forma, conforme detalhado na Cláusula Sétima.</p>
    </div>
  </div>

  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">III</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusula Segunda</div>
        <h2>Do Procedimento &amp; Execução</h2>
      </div>
    </div>
    ...
    <div class="rk-notice">
      <div class="icon">!</div>
      <div class="body">
        <div class="t">Obrigação de Meio</div>
        <p>A presente prestação de serviços configura obrigação de meio, e não de resultado. A <strong>CONTRATADA</strong> compromete-se a empregar seu melhor esforço técnico e metodológico, sem garantia de retorno financeiro específico, o qual depende da aplicação efetiva pelo(a) <strong>CONTRATANTE</strong>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="rk-page">
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">IV</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusula Terceira</div>
        <h2>Do Investimento &amp; Pagamento</h2>
      </div>
    </div>
  ...
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">V</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusula Quarta</div>
        <h2>Das Penalidades &amp; Multas</h2>
      </div>
    </div>
    ...
    <table class="rk-table">
      <thead>
        <tr><th>Hipótese</th><th>Penalidade</th><th>Base</th></tr>
      </thead>
      <tbody>
...
<div class="rk-page">
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">VI</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusulas Quinta &amp; Sexta</div>
        <h2>Da Vigência &amp; Rescisão</h2>
      </div>
    </div>
    ...
    <div class="rk-grid-2">
      <div class="rk-card">
        <div class="h">Rescisão Imotivada</div>
        <p>O(A) <strong>CONTRATANTE</strong> poderá rescindir o presente contrato a qualquer momento, mediante comunicação por escrito com 15 (quinze) dias de antecedência, sujeitando-se à multa rescisória prevista na Cláusula Quarta.</p>
      </div>
      <div class="rk-card">
        <div class="h">Rescisão Motivada</div>
        <p>A <strong>CONTRATADA</strong> poderá rescindir, de pleno direito, este contrato em caso de inadimplemento, quebra de confidencialidade ou conduta incompatível com o programa, sem prejuízo da cobrança dos valores devidos.</p>
      </div>
    </div>
    ...
    <div class="rk-notice">
      <div class="icon">§</div>
      <div class="body">
        <div class="t">Direito de Arrependimento — Art. 49, CDC</div>
        <p>Em contratações realizadas fora do estabelecimento comercial, fica assegurado ao(à) <strong>CONTRATANTE</strong> o direito de arrependimento no prazo de 7 (sete) dias corridos, contados da assinatura, com restituição integral dos valores eventualmente pagos.</p>
      </div>
    </div>
  </div>
  ...
  <div class="rk-section">
    <div class="rk-section-head">
      <div class="rk-section-num">VII</div>
      <div class="rk-section-titles">
        <div class="eyebrow">Cláusula Sétima</div>
        <h2>Disposições Gerais &amp; Foro</h2>
      </div>
    </div>
    ...
    <div class="rk-sign-block">
      ...
      <div class="rk-sign-grid">
        <div class="rk-sign">
          ...
          <div class="role">Contratada</div>
          <div class="name">Rykas Mentoring</div>
          <div class="doc">CNPJ {{COMPANY_CNPJ}}</div>
        </div>
        <div class="rk-sign">
          <div class="line"></div>
          <div class="role">Contratante</div>
          <div class="name">{{CLIENT_NAME}}</div>
          <div class="doc">{{CLIENT_DOCUMENT}}</div>
        </div>
      </div>
      ...
      <div class="rk-sign-grid" style="margin-top:24px;">
        <div class="rk-sign">
          <div class="line"></div>
          <div class="role">Testemunha 01</div>
          <div class="name">&nbsp;</div>
          <div class="doc">Nome &middot; CPF</div>
        </div>
        <div class="rk-sign">
          <div class="line"></div>
          <div class="role">Testemunha 02</div>
          <div class="name">&nbsp;</div>
          <div class="doc">Nome &middot; CPF</div>
        </div>
      </div>
...
</div>$RYKAS$, updated_at = now() WHERE id = '23a8cada-3181-4b92-bdf2-194e04083c39';