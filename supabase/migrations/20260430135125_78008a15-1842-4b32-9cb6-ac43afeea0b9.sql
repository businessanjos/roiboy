...
.rk-cover h1{ font-family:'Playfair Display', Georgia, serif; font-size:54pt; line-height:1.02; font-weight:700; margin:0 0 24px; letter-spacing:-.02em; color:#fff; }
...
.rk-cover-meta .item .v{ font-family:'Playfair Display', serif; font-size:14pt; font-weight:600; color:var(--ink); line-height:1.3; }
...
.rk-toc h3{ font-family:'Playfair Display', serif; font-size:9pt; font-weight:600; letter-spacing:.4em; text-transform:uppercase; color:var(--ink); margin:0 0 24px; padding-bottom:14px; border-bottom:2px solid var(--ink); }
...
.rk-toc ol li::before{ content:counter(toc, decimal-leading-zero); font-family:'Playfair Display', serif; font-size:13pt; font-weight:600; color:var(--ink); min-width:36px; }
...
.rk-section-num{ font-family:'Playfair Display', serif; font-size:42pt; font-weight:700; line-height:1; color:var(--ink); letter-spacing:-.02em; }
...
.rk-section-titles h2{ font-family:'Playfair Display', serif; font-size:24pt; font-weight:700; margin:0; line-height:1.15; color:var(--ink); letter-spacing:-.015em; }
...
.rk-clause-num{ font-family:'Playfair Display', serif; font-size:11pt; font-style:italic; font-weight:600; color:var(--ink); padding-top:2px; }
...
.rk-party .name{ font-family:'Playfair Display', serif; font-size:18pt; font-weight:600; color:var(--ink); margin-bottom:14px; line-height:1.2; }
...
.rk-pullquote{ font-family:'Playfair Display', serif; font-size:14pt; font-style:italic; font-weight:500; line-height:1.45; color:var(--ink); border-left:3px solid var(--ink); padding:8px 0 8px 22px; margin:24px 0; max-width:80%; }
...
.rk-pillar .num{ font-family:'Playfair Display', serif; font-size:24pt; font-weight:700; color:var(--ink); line-height:1; margin-bottom:12px; }
...
.rk-hero .total{ font-family:'Playfair Display', serif; font-size:42pt; font-weight:700; color:#fff; line-height:1; letter-spacing:-.02em; margin-bottom:8px; }
...
.rk-hero-grid .v{ font-family:'Playfair Display', serif; font-size:14pt; font-weight:600; color:#fff; }
...
.rk-table .col-penalty{ font-family:'Playfair Display', serif; font-size:15pt; font-weight:700; color:var(--ink); width:18%; letter-spacing:-.01em; }
...
.rk-notice .icon{ width:40px; height:40px; background:#000; color:#fff; display:flex; align-items:center; justify-content:center; font-family:'Playfair Display', serif; font-size:20pt; font-weight:700; line-height:1; flex-shrink:0; }
...
.rk-card .h{ font-family:'Playfair Display', serif; font-size:16pt; font-weight:700; color:var(--ink); margin-bottom:12px; letter-spacing:-.01em; padding-bottom:10px; border-bottom:1px solid var(--line); }
...
.rk-sign-intro{ font-family:'Playfair Display', serif; font-size:13pt; font-style:italic; color:var(--ink-2); text-align:center; margin-bottom:56px; }
...
.rk-sign .name{ font-family:'Playfair Display', serif; font-size:14pt; font-weight:700; color:var(--ink); letter-spacing:-.005em; }
...
.rk-footer .brand{ font-family:'Playfair Display', serif; font-size:13pt; font-style:italic; font-weight:700; letter-spacing:.04em; text-transform:none; color:var(--ink); }
