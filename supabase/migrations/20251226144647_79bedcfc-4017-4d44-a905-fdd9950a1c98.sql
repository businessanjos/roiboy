...
-- Update the initialize_ai_agent_functions to rename support_requests to "Central de Suporte"
...
-- Update existing records to rename support_requests
UPDATE public.ai_agent_functions 
SET 
  function_name = 'Central de Suporte',
  description = 'Analisa e categoriza tickets de suporte, identificando prioridade e encaminhando para atendimento adequado.',
  instructions = 'Analise tickets de suporte para:
...
Sempre peça evidências (prints, vídeos) quando necessário.',
  is_enabled = true
WHERE function_key = 'support_requests';
