-- Update the handle_new_user trigger to skip account creation for team members
...
DECLARE
  new_account_id uuid;
BEGIN
  -- Skip if this user was created as a team member (has is_team_member flag in metadata)
