    ...
    extend: {
      ...
      colors: {
        ...
        score: {
          ...
          unstable: "hsl(var(--score-unstable))",
          healthy: "hsl(var(--score-healthy))",
          delighted: "hsl(var(--score-delighted))",
        },
        trend: {
          up: "hsl(var(--trend-up))",
        ...
        zapp: {
          bg: "hsl(var(--zapp-bg))",
          "bg-dark": "hsl(var(--zapp-bg-dark))",
          panel: "hsl(var(--zapp-panel))",
          "panel-header": "hsl(var(--zapp-panel-header))",
          text: "hsl(var(--zapp-text))",
          "text-muted": "hsl(var(--zapp-text-muted))",
          accent: "hsl(var(--zapp-accent))",
          "accent-hover": "hsl(var(--zapp-accent-hover))",
          "message-out": "hsl(var(--zapp-message-out))",
      ...
      keyframes: {
        ...
        "highlight-glow": {
          ...
          "50%": { 
            boxShadow: "0 0 0 3px hsl(var(--primary) / 0.5), 0 0 30px hsl(var(--primary) / 0.4)",
