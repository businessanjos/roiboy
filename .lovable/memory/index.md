...
- [FAQ do Financeiro](mem://features/financial/faq-central-de-ajuda-pt) — /financial/ajuda com busca por IA restrita aos artigos cadastrados (edge function financial-faq-search)
...
- [Seletores de pessoa no Marketing](mem://features/marketing/team-selectors-scope-pt) — Todo seletor de pessoa no Marketing lista só o time de marketing via useMarketingTeamUsers
...
- [Ligações 3C como atividade + IA](mem://integrations/telephony/3c-plus-call-activities-ai-pt) — Vínculo automático, atividade na timeline, transcrição e resumo de vendas
